/**
 * Find the number which was present odd number of times
 * Xor of number vs number will be nullified
 * time complexity - O(n)
 * space complexity - O(1)
 */

const findOddNumberFromArray = (a) => {
  let ans = a[0];
